...
#define MATCH_VLSEG2W_V 0x30006007
#define MASK_VLSEG2W_V  0xfdf0707f
#define MATCH_VLSEG3W_V 0x50006007
#define MASK_VLSEG3W_V  0xfdf0707f
#define MATCH_VLSEG4W_V 0x70006007
#define MASK_VLSEG4W_V  0xfdf0707f
#define MATCH_VLSEG5W_V 0x90006007
#define MASK_VLSEG5W_V  0xfdf0707f
#define MATCH_VLSEG6W_V 0xb0006007
#define MASK_VLSEG6W_V  0xfdf0707f
#define MATCH_VLSEG7W_V 0xd0006007
#define MASK_VLSEG7W_V  0xfdf0707f
#define MATCH_VLSEG8W_V 0xf0006007
#define MASK_VLSEG8W_V  0xfdf0707f
#define MATCH_VSW_V 0x6027
#define MASK_VSW_V  0xfdf0707f
#define MATCH_VSSEG2W_V 0x20006027
#define MASK_VSSEG2W_V  0xfdf0707f
#define MATCH_VSSEG3W_V 0x40006027
#define MASK_VSSEG3W_V  0xfdf0707f
#define MATCH_VSSEG4W_V 0x60006027
#define MASK_VSSEG4W_V  0xfdf0707f
#define MATCH_VSSEG5W_V 0x80006027
#define MASK_VSSEG5W_V  0xfdf0707f
#define MATCH_VSSEG6W_V 0xa0006027
#define MASK_VSSEG6W_V  0xfdf0707f
#define MATCH_VSSEG7W_V 0xc0006027
#define MASK_VSSEG7W_V  0xfdf0707f
#define MATCH_VSSEG8W_V 0xe0006027
#define MASK_VSSEG8W_V  0xfdf0707f
#define MATCH_VLSW_V 0x18006007
#define MASK_VLSW_V  0xfc00707f
#define MATCH_VLSSEG2W_V 0x38006007
#define MASK_VLSSEG2W_V  0xfc00707f
#define MATCH_VLSSEG3W_V 0x58006007
#define MASK_VLSSEG3W_V  0xfc00707f
#define MATCH_VLSSEG4W_V 0x78006007
#define MASK_VLSSEG4W_V  0xfc00707f
#define MATCH_VLSSEG5W_V 0x98006007
#define MASK_VLSSEG5W_V  0xfc00707f
#define MATCH_VLSSEG6W_V 0xb8006007
#define MASK_VLSSEG6W_V  0xfc00707f
#define MATCH_VLSSEG7W_V 0xd8006007
#define MASK_VLSSEG7W_V  0xfc00707f
#define MATCH_VLSSEG8W_V 0xf8006007
#define MASK_VLSSEG8W_V  0xfc00707f
#define MATCH_VSSW_V 0x8006027
#define MASK_VSSW_V  0xfc00707f
#define MATCH_VSSSEG2W_V 0x28006027
#define MASK_VSSSEG2W_V  0xfc00707f
#define MATCH_VSSSEG3W_V 0x48006027
#define MASK_VSSSEG3W_V  0xfc00707f
#define MATCH_VSSSEG4W_V 0x68006027
#define MASK_VSSSEG4W_V  0xfc00707f
#define MATCH_VSSSEG5W_V 0x88006027
#define MASK_VSSSEG5W_V  0xfc00707f
#define MATCH_VSSSEG6W_V 0xa8006027
#define MASK_VSSSEG6W_V  0xfc00707f
#define MATCH_VSSSEG7W_V 0xc8006027
#define MASK_VSSSEG7W_V  0xfc00707f
#define MATCH_VSSSEG8W_V 0xe8006027
#define MASK_VSSSEG8W_V  0xfc00707f
#define MATCH_VFADD_VF 0x5057
#define MASK_VFADD_VF  0xfc00707f
#define MATCH_VFREDSUM_VF 0x4005057
#define MASK_VFREDSUM_VF  0xfc00707f
#define MATCH_VFSUB_VF 0x8005057
#define MASK_VFSUB_VF  0xfc00707f
#define MATCH_VFREDOSUM_VF 0xc005057
#define MASK_VFREDOSUM_VF  0xfc00707f
#define MATCH_VFMIN_VF 0x10005057
#define MASK_VFMIN_VF  0xfc00707f
#define MATCH_VFREDMIN_VF 0x14005057
#define MASK_VFREDMIN_VF  0xfc00707f
#define MATCH_VFMAX_VF 0x18005057
#define MASK_VFMAX_VF  0xfc00707f
#define MATCH_VFREDMAX_VF 0x1c005057
#define MASK_VFREDMAX_VF  0xfc00707f
#define MATCH_VFSGNJ_VF 0x20005057
#define MASK_VFSGNJ_VF  0xfc00707f
#define MATCH_VFSGNN_VF 0x24005057
#define MASK_VFSGNN_VF  0xfc00707f
#define MATCH_VFSGNX_VF 0x28005057
#define MASK_VFSGNX_VF  0xfc00707f
#define MATCH_VFADD_VV 0x1057
#define MASK_VFADD_VV  0xfc00707f
#define MATCH_VFREDSUM_VV 0x4001057
#define MASK_VFREDSUM_VV  0xfc00707f
#define MATCH_VFSUB_VV 0x8001057
#define MASK_VFSUB_VV  0xfc00707f
#define MATCH_VFREDOSUM_VV 0xc001057
#define MASK_VFREDOSUM_VV  0xfc00707f
#define MATCH_VFMIN_VV 0x10001057
#define MASK_VFMIN_VV  0xfc00707f
#define MATCH_VFREDMIN_VV 0x14001057
#define MASK_VFREDMIN_VV  0xfc00707f
#define MATCH_VFMAX_VV 0x18001057
#define MASK_VFMAX_VV  0xfc00707f
#define MATCH_VFREDMAX_VV 0x1c001057
#define MASK_VFREDMAX_VV  0xfc00707f
#define MATCH_VFSGNJ_VV 0x20001057
#define MASK_VFSGNJ_VV  0xfc00707f
#define MATCH_VFSGNN_VV 0x24001057
#define MASK_VFSGNN_VV  0xfc00707f
#define MATCH_VFSGNX_VV 0x28001057
#define MASK_VFSGNX_VV  0xfc00707f
#define MATCH_VFMV_F_S 0x30005057
#define MASK_VFMV_F_S  0xfc0ff07f
#define MATCH_VFMV_S_F 0x34005057
#define MASK_VFMV_S_F  0xfdf0707f
#define MATCH_VMERGE_VV 0x5c001057
#define MASK_VMERGE_VV  0xfc00707f
#define MATCH_VFDIV_VV 0x80001057
#define MASK_VFDIV_VV  0xfc00707f
#define MATCH_VFUNARY0_VV 0x88001057
#define MASK_VFUNARY0_VV  0xfc00707f
#define MATCH_VFUNARY1_VV 0x8c001057
#define MASK_VFUNARY1_VV  0xfc00707f
...
DECLARE_INSN(vlseg2w_v, MATCH_VLSEG2W_V, MASK_VLSEG2W_V)
DECLARE_INSN(vlseg3w_v, MATCH_VLSEG3W_V, MASK_VLSEG3W_V)
DECLARE_INSN(vlseg4w_v, MATCH_VLSEG4W_V, MASK_VLSEG4W_V)
DECLARE_INSN(vlseg5w_v, MATCH_VLSEG5W_V, MASK_VLSEG5W_V)
DECLARE_INSN(vlseg6w_v, MATCH_VLSEG6W_V, MASK_VLSEG6W_V)
DECLARE_INSN(vlseg7w_v, MATCH_VLSEG7W_V, MASK_VLSEG7W_V)
DECLARE_INSN(vlseg8w_v, MATCH_VLSEG8W_V, MASK_VLSEG8W_V)
DECLARE_INSN(vsw_v, MATCH_VSW_V, MASK_VSW_V)
DECLARE_INSN(vsseg2w_v, MATCH_VSSEG2W_V, MASK_VSSEG2W_V)
DECLARE_INSN(vsseg3w_v, MATCH_VSSEG3W_V, MASK_VSSEG3W_V)
DECLARE_INSN(vsseg4w_v, MATCH_VSSEG4W_V, MASK_VSSEG4W_V)
DECLARE_INSN(vsseg5w_v, MATCH_VSSEG5W_V, MASK_VSSEG5W_V)
DECLARE_INSN(vsseg6w_v, MATCH_VSSEG6W_V, MASK_VSSEG6W_V)
DECLARE_INSN(vsseg7w_v, MATCH_VSSEG7W_V, MASK_VSSEG7W_V)
DECLARE_INSN(vsseg8w_v, MATCH_VSSEG8W_V, MASK_VSSEG8W_V)
DECLARE_INSN(vlsw_v, MATCH_VLSW_V, MASK_VLSW_V)
DECLARE_INSN(vlsseg2w_v, MATCH_VLSSEG2W_V, MASK_VLSSEG2W_V)
DECLARE_INSN(vlsseg3w_v, MATCH_VLSSEG3W_V, MASK_VLSSEG3W_V)
DECLARE_INSN(vlsseg4w_v, MATCH_VLSSEG4W_V, MASK_VLSSEG4W_V)
DECLARE_INSN(vlsseg5w_v, MATCH_VLSSEG5W_V, MASK_VLSSEG5W_V)
DECLARE_INSN(vlsseg6w_v, MATCH_VLSSEG6W_V, MASK_VLSSEG6W_V)
DECLARE_INSN(vlsseg7w_v, MATCH_VLSSEG7W_V, MASK_VLSSEG7W_V)
DECLARE_INSN(vlsseg8w_v, MATCH_VLSSEG8W_V, MASK_VLSSEG8W_V)
DECLARE_INSN(vssw_v, MATCH_VSSW_V, MASK_VSSW_V)
DECLARE_INSN(vssseg2w_v, MATCH_VSSSEG2W_V, MASK_VSSSEG2W_V)
DECLARE_INSN(vssseg3w_v, MATCH_VSSSEG3W_V, MASK_VSSSEG3W_V)
DECLARE_INSN(vssseg4w_v, MATCH_VSSSEG4W_V, MASK_VSSSEG4W_V)
DECLARE_INSN(vssseg5w_v, MATCH_VSSSEG5W_V, MASK_VSSSEG5W_V)
DECLARE_INSN(vssseg6w_v, MATCH_VSSSEG6W_V, MASK_VSSSEG6W_V)
DECLARE_INSN(vssseg7w_v, MATCH_VSSSEG7W_V, MASK_VSSSEG7W_V)
DECLARE_INSN(vssseg8w_v, MATCH_VSSSEG8W_V, MASK_VSSSEG8W_V)
DECLARE_INSN(vfadd_vf, MATCH_VFADD_VF, MASK_VFADD_VF)
DECLARE_INSN(vfredsum_vf, MATCH_VFREDSUM_VF, MASK_VFREDSUM_VF)
DECLARE_INSN(vfsub_vf, MATCH_VFSUB_VF, MASK_VFSUB_VF)
DECLARE_INSN(vfredosum_vf, MATCH_VFREDOSUM_VF, MASK_VFREDOSUM_VF)
DECLARE_INSN(vfmin_vf, MATCH_VFMIN_VF, MASK_VFMIN_VF)
DECLARE_INSN(vfredmin_vf, MATCH_VFREDMIN_VF, MASK_VFREDMIN_VF)
DECLARE_INSN(vfmax_vf, MATCH_VFMAX_VF, MASK_VFMAX_VF)
DECLARE_INSN(vfredmax_vf, MATCH_VFREDMAX_VF, MASK_VFREDMAX_VF)
DECLARE_INSN(vfsgnj_vf, MATCH_VFSGNJ_VF, MASK_VFSGNJ_VF)
DECLARE_INSN(vfsgnn_vf, MATCH_VFSGNN_VF, MASK_VFSGNN_VF)
DECLARE_INSN(vfsgnx_vf, MATCH_VFSGNX_VF, MASK_VFSGNX_VF)
DECLARE_INSN(vfadd_vv, MATCH_VFADD_VV, MASK_VFADD_VV)
DECLARE_INSN(vfredsum_vv, MATCH_VFREDSUM_VV, MASK_VFREDSUM_VV)
DECLARE_INSN(vfsub_vv, MATCH_VFSUB_VV, MASK_VFSUB_VV)
DECLARE_INSN(vfredosum_vv, MATCH_VFREDOSUM_VV, MASK_VFREDOSUM_VV)
DECLARE_INSN(vfmin_vv, MATCH_VFMIN_VV, MASK_VFMIN_VV)
DECLARE_INSN(vfredmin_vv, MATCH_VFREDMIN_VV, MASK_VFREDMIN_VV)
DECLARE_INSN(vfmax_vv, MATCH_VFMAX_VV, MASK_VFMAX_VV)
DECLARE_INSN(vfredmax_vv, MATCH_VFREDMAX_VV, MASK_VFREDMAX_VV)
DECLARE_INSN(vfsgnj_vv, MATCH_VFSGNJ_VV, MASK_VFSGNJ_VV)
DECLARE_INSN(vfsgnn_vv, MATCH_VFSGNN_VV, MASK_VFSGNN_VV)
DECLARE_INSN(vfsgnx_vv, MATCH_VFSGNX_VV, MASK_VFSGNX_VV)
...
DECLARE_INSN(vfunary0_vv, MATCH_VFUNARY0_VV, MASK_VFUNARY0_VV)
DECLARE_INSN(vfunary1_vv, MATCH_VFUNARY1_VV, MASK_VFUNARY1_VV)
