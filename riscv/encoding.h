...
#endif
#ifdef CSR_DECLARE
CSR_DECLARE(mcycle, CSR_MCYCLE)
CSR_DECLARE(minstret, CSR_MINSTRET)
CSR_DECLARE(scounteren, CSR_SCOUNTEREN)
CSR_DECLARE(mcounteren, CSR_MCOUNTEREN)
CSR_DECLARE(sstatus, CSR_SSTATUS)
CSR_DECLARE(sip, CSR_SIP)
CSR_DECLARE(sie, CSR_SIE)
CSR_DECLARE(sepc, CSR_SEPC)
CSR_DECLARE(stval, CSR_STVAL)
CSR_DECLARE(stvec, CSR_STVEC)
CSR_DECLARE(scause, CSR_SCAUSE)
CSR_DECLARE(sscratch, CSR_SSCRATCH)
CSR_DECLARE(mstatus, CSR_MSTATUS)
CSR_DECLARE(mip, CSR_MIP)
CSR_DECLARE(mie, CSR_MIE)
CSR_DECLARE(mepc, CSR_MEPC)
CSR_DECLARE(mtval, CSR_MTVAL)
CSR_DECLARE(misa, CSR_MISA)
CSR_DECLARE(marchid, CSR_MARCHID)
CSR_DECLARE(mimpid, CSR_MIMPID)
CSR_DECLARE(mvendorid, CSR_MVENDORID)
CSR_DECLARE(mhartid, CSR_MHARTID)
CSR_DECLARE(mtvec, CSR_MTVEC)
CSR_DECLARE(tselect, CSR_TSELECT)
CSR_DECLARE(tdata1, CSR_TDATA1)
CSR_DECLARE(tdata2, CSR_TDATA2)
CSR_DECLARE(tdata3, CSR_TDATA3)
#endif
#ifdef DECLARE_CAUSE
