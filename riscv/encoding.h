...
DECLARE_INSN(cretk, MATCH_CRETK, MASK_CRETK)
DECLARE_INSN(crdtk, MATCH_CRDTK, MASK_CRDTK)
DECLARE_INSN(cremk, MATCH_CREMK, MASK_CREMK)
DECLARE_INSN(crdmk, MATCH_CRDMK, MASK_CRDMK)
DECLARE_INSN(creak, MATCH_CREAK, MASK_CREAK)
DECLARE_INSN(crdak, MATCH_CRDAK, MASK_CRDAK)
DECLARE_INSN(crebk, MATCH_CREBK, MASK_CREBK)
DECLARE_INSN(crdbk, MATCH_CRDBK, MASK_CRDBK)
#endif
#ifdef DECLARE_CSR
